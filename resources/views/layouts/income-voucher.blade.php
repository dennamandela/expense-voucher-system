      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Bon Penerimaan</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Bon Penerimaan</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
  ...
  document.getElementById('addRow').addEventListener('click', function () {
    ...
    const row = `
      <tr>
        ...
        <td>
          <input type="number" name="details[${index}][amount]" class="form-control amount" min="0" required>
        </td>
